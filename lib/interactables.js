    ...
    {scriptColor:'#44ff44', objectName: 'casette', scriptName: 'casette', script: 'I am a casette tape', scriptOptions:['No thanks.','Sure.']},
    {
        ...
        onResult: function(result){
            if (result == 1){
                ...
                setTimeout(_=>window.open('https://fenwick.pizza/weather-duck/index.html'),1000)
                
            } else if (result == 2){
                unlockOutfitByName('poncho')
                setTimeout(_=>window.open('https://fenwick.pizza/weather-duck/index.html?location=19.705556,-155.085833'),1000)
            } else {
                // *FINE BE THAT WAY*
            }
        }
