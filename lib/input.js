...
function KeyController(){
    ...
    if('ontouchstart' in document.documentElement){
      ...
      function stickMove(e){
        ...
        // get size of stick
        var rect = stick.getClientRects()[0];
        ...
        self.touchAxes.setZ(self.touchAxes.z * 0.5 + 0.5* dY/deflectionMax);
        self.touchAxes.setX(self.touchAxes.x * 0.5 + 0.5* dX/deflectionMax);

        stickCenterEl.style.left = self.touchAxes.x * deflectionMax;
        stickCenterEl.style.bottom = self.touchAxes.z * deflectionMax;
    ...
    function checkKeys(){
      ...
      if ('ontouchstart' in document.documentElement){
        ...
        self.undampedMovementAxes.add(self.dampedTouchAxes)
  
        stickCenterEl.style.left = self.dampedTouchAxes.x * stickCenterEl.getBoundingClientRect().width/2;
        stickCenterEl.style.bottom = self.dampedTouchAxes.z * stickCenterEl.getBoundingClientRect().width/2;  
      }
