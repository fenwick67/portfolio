...
class PlayerCam{
    ...
    update(delta){
        ...
        var playerToCamCenterXZ = new Vector3()
            .subVectors(entities.boxedPlayerFollower.position, dolly.getCamPosition(entities.boxedPlayerFollower.position))
            .multiply(new Vector3(1,0,1))
            .normalize();
        var offsetX = playerToCamCenterXZ.x * this.baseOffset.z;
        var offsetZ = playerToCamCenterXZ.z * this.baseOffset.z;
        var offset = new Vector3(offsetX, this.baseOffset.y, offsetZ)
        this.camera.position.addVectors(offset, entities.boxedPlayerFollower.position)
