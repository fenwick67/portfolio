...
void main()
{
    ...
    // curvature shader!
    // vec3 modelPositionFromCamera = modelPosition - cameraPosition;
    // modelPosition.y = modelPosition.y+  -0.0005*modelPositionFromCamera.z*modelPositionFromCamera.z;
    // modelPosition.y = modelPosition.y+  -0.0005*modelPositionFromCamera.x*modelPositionFromCamera.x;


    vec4 mvPosition = viewMatrix * vec4(modelPosition, 1.0);
