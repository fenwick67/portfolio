import { ShaderMaterial, Mesh, PlaneGeometry, Side, DoubleSide } from "three"
...
`
var uniforms = {time: {value: 1.0}, uCurrentSpeed: {value: 0}}
...
function streamMaterial(speed){
    var unis = {time: {value: 1.0}, uCurrentSpeed: {value: Math.max(speed||0.2, 0.2)}}
