...
function getOutdoorLighting(){
    ...
    //     this.shadow.camera.left = this.position.x - d;
    //     this.shadow.camera.right = this.position.x + d;
    //     this.shadow.camera.top = this.position.z - d;
    //     this.shadow.camera.bottom = this.position.z + d;
    // }).bind(dirLight)
